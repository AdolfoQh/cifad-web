  ...
  return (
    <div style={{ marginTop: topMargin ? 56 : 0 }}>
      <div style={{
        ...
        color: T.muted, textTransform: 'uppercase', letterSpacing: '.15em', marginBottom: 20,
      }}>{label}</div>
      {children}
    </div>
  )
    ...
    return (
      <div style={{
        ...
        <span style={{
          ...
          color: T.muted, textTransform: 'uppercase', letterSpacing: '.18em',
  ...
  return (
    <div style={{ minHeight: '100vh', background: T.bg, color: T.text }}>
      ...
      <section style={{
        ...
        {/* Mesh gradient */}
        <MeshBlobs blobs={[
          { color: lab.color, opacity: .15, size: 700, top: -100, right: -100 },
          { color: T.accent, opacity: .08, size: 500, bottom: -80, left: -80 },
        ]} />
        ...
        <div style={{ maxWidth: 1280, margin: '0 auto', position: 'relative', zIndex: 1 }}>
          <Link
            ...
            style={{
              ...
              color: T.muted, textDecoration: 'none', marginBottom: 48,
              transition: 'color .2s',
            }}
          ...
          <h1 style={{
            ...
            margin: 0, marginBottom: 28, maxWidth: 900,
          }}>{lab.name}</h1>

          <p style={{
            fontFamily: T.body, fontSize: 20, lineHeight: 1.55,
            color: T.muted, maxWidth: 680, margin: 0,
          }}>{lab.shortDescription}</p>
        </div>
      </section>

      {/* Main content */}
      <section style={{ padding: isMobile ? '48px 20px 80px' : '80px 32px 120px', background: T.surface }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '2fr 1fr', gap: isMobile ? 32 : 64, alignItems: 'start' }}>
            ...
            <div>
              <FadeIn>
                <div style={{
                  fontFamily: T.body, fontSize: 10,
                  color: T.muted, textTransform: 'uppercase', letterSpacing: '.15em', marginBottom: 16,
                }}>Sobre el laboratorio</div>
                {lab.description.split('\n\n').map((p, i) => (
                  <p key={i} style={{
                    fontFamily: T.body, fontSize: 18, lineHeight: 1.65,
                    color: T.muted, marginBottom: i < lab.description.split('\n\n').length - 1 ? 20 : 48,
                  }}>{p}</p>
                ))}
              </FadeIn>
                    ...
                    {proyectos.map((p, i) => {
                      ...
                      return (
                        <div key={p._id} style={{
                          ...
                          padding: '18px 24px',
                          borderBottom: i < proyectos.length - 1 ? `1px solid ${T.border}` : 'none',
                        }}>
                          <div>
                            <div style={{
                              fontFamily: T.display, fontSize: 15,
                          ...
                          <div style={{ display: 'flex', alignItems: 'center', gap: 12, flexShrink: 0 }}>
                            ...
                            <span style={{
                              ...
                              background: isActive ? `${lab.color}20` : T.border,
                              border: `1px solid ${isActive ? lab.color : T.border}`,
                              fontFamily: T.body, fontSize: 10,
                              color: isActive ? lab.color : T.muted,
              ...
              {!loadingData && novedades.length > 0 && (
                <FadeIn delay={.3}>
                  <ContentSection label="Novedades" topMargin>
                      ...
                      {novedades.map((item) => (
                        ...
                        >
                          ...
                          <div style={{ padding: 20 }}>
                            ...
                            <div style={{
                              fontFamily: T.display, fontSize: 15,
                              fontWeight: 700, color: T.text, marginBottom: 6,
                            }}>{item.titulo}</div>
                            {item.resumen && (
                              <p style={{
                                fontFamily: T.body, fontSize: 13,
                                lineHeight: 1.5, color: T.muted, margin: 0,
                              }}>{item.resumen}</p>
                            )}
                            <div style={{
                              fontFamily: T.body, fontSize: 12,
              ...
              {!loadingData && publicaciones.length > 0 && (
                <FadeIn delay={.35}>
                  <ContentSection label="Publicaciones" topMargin>
                    <div style={{
                      background: T.surface2, border: `1px solid ${T.border}`,
                      borderRadius: 16, overflow: 'hidden',
                    }}>
                      {publicaciones.map((p, i) => (
                        <div key={p._id} style={{
                          padding: '18px 24px',
                          borderBottom: i < publicaciones.length - 1 ? `1px solid ${T.border}` : 'none',
                        }}>
                          <div style={{
                            fontFamily: T.display, fontSize: 15,
                            fontWeight: 700, color: T.text, marginBottom: 4,
                          ...
                          <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginTop: 6 }}>
                            ...
                            {p.doi && (
                              <span style={{
                                fontFamily: T.body, fontSize: 11, color: lab.color,
                              }}>DOI: {p.doi}</span>
                            )}
                            {p.url && (
              ...
              {!loadingData && eventos.length > 0 && (
                <FadeIn delay={.4}>
                  <ContentSection label="Eventos" topMargin>
                    <div style={{
                      background: T.surface2, border: `1px solid ${T.border}`,
                      borderRadius: 16, overflow: 'hidden',
                    }}>
                      {eventos.map((e, i) => (
                        <div key={e._id} style={{
                          padding: '18px 24px',
                          borderBottom: i < eventos.length - 1 ? `1px solid ${T.border}` : 'none',
                          ...
                          <div>
                            ...
                            {e.lugar && (
                              <div style={{
                                fontFamily: T.body, fontSize: 12, color: T.muted,
                              }}>{e.lugar}</div>
                            )}
                          </div>
                    ...
                    {lab.responsible.map((r, i) => {
                      ...
                      return (
                        <div key={r} style={{
                          ...
                          padding: '8px 0',
                          borderBottom: i < lab.responsible.length - 1 ? `1px solid ${T.border}` : 'none',
                        }}>
                          {img && (
                          ...
                          <span style={{ fontFamily: T.body, fontSize: 14, color: T.text }}>
                            {r}
                          </span>
                        </div>
                      )
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column' }}>
                      {lab.members.map((m, i) => (
                        <div key={m.name} style={{
                          ...
                          padding: '8px 0',
                          borderBottom: i < lab.members.length - 1 ? `1px solid ${T.border}` : 'none',
                        }}>
                          ...
                          {m.role && (
                            <span style={{ fontFamily: T.body, fontSize: 10,
                              color: T.muted, textTransform: 'uppercase', letterSpacing: '.1em', flexShrink: 0 }}>
                              {m.role}
                            </span>
                          )}
                        </div>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column' }}>
                      {lab.collaborations.map((c, i) => (
                        <div key={c} style={{
                          ...
                          padding: '8px 0',
                          borderBottom: i < lab.collaborations.length - 1 ? `1px solid ${T.border}` : 'none',
                        }}>{c}</div>
                      ))}
                    </div>
                  </div>
