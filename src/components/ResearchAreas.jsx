            ...
            {researchAreas.map((a, i) => (
              <div key={a.id}>
                <button onClick={() => setActive(active === i ? -1 : i)} style={{
                  ...
                  borderBottom: i === researchAreas.length - 1 && active !== i ? `1px solid ${T.border}` : 'none',
                  ...
                  <div style={{
                    ...
                    <div style={{ position: 'relative' }}>
                      <div style={{
                        ...
                        color: T.accent, letterSpacing: '.15em', marginBottom: 12,
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.5fr', gap: 60 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 0 }}>
              {researchAreas.map((a, i) => (
                <button key={a.id} onClick={() => setActive(i)} style={{
                  ...
                  borderTop: `1px solid ${T.border}`,
                  borderBottom: i === researchAreas.length - 1 ? `1px solid ${T.border}` : 'none',
            ...
            <div style={{
              ...
              <div style={{ position: 'relative' }}>
                <div style={{
                  fontFamily: T.body, fontSize: 11,
                  color: T.accent, letterSpacing: '.15em', marginBottom: 20,
                ...
                <p style={{
                  fontFamily: T.body, fontSize: 16, lineHeight: 1.65,
                  color: T.muted, margin: 0,
